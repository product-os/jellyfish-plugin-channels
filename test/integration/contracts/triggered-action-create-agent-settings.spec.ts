...
describe('triggered-action-create-agent-settings', () => {
	test('linking a user to a channel as an agent should create an agent-settings contract', async () => {
		// Add new channel
